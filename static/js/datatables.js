 ...
 *   https://datatables.net/download/#bs/jq-2.2.0,dt-1.10.11,b-1.1.2,b-print-1.1.2,fc-3.2.1,fh-3.1.1,r-2.0.2,sc-1.4.1,se-1.1.2
 *
 * Included libraries:
 *   jQuery 2.2.0, DataTables 1.10.11, Buttons 1.1.2, Print view 1.1.2, FixedColumns 3.2.1, FixedHeader 3.1.1, Responsive 2.0.2, Scroller 1.4.1, Select 1.1.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/jq-2.2.0,dt-1.10.11,b-1.1.2,b-print-1.1.2,fc-3.2.1,fh-3.1.1,r-2.0.2,sc-1.4.1,se-1.1.2",
