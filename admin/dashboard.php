                    ...
                    <div class="span3">
                        <div class="sidebar">
                            ...
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="add_child.php"><i class="menu-icon icon-book"></i>My Child </a></li>
                            ...
                            <div class="btn-controls">
                                ...
                                <div class="btn-box-row row-fluid">
                                    <div class="span8">
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12">
                                                <a href="#" class="btn-box small span4"><i class="icon-save"></i><b>All Foods</b>
                                                </a><a href="#" class="btn-box small span4"><i class="icon-bullhorn"></i><b>Child Records</b>
